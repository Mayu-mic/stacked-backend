...
class StacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stack" do
    assert_difference('Stack.count') do
      post stacks_url, params: { stack: { created_by_id: @stack.created_by_id, list_id: @stack.list_id, note: @stack.note, status: @stack.status, title: @stack.title } }, as: :json
    end
  ...
  test "should update stack" do
    patch stack_url(@stack), params: { stack: { created_by_id: @stack.created_by_id, list_id: @stack.list_id, note: @stack.note, status: @stack.status, title: @stack.title } }, as: :json
    assert_response 200
  end
